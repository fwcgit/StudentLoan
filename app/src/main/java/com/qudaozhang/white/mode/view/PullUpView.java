 ...
 *
 */
public class PullUpView extends LinearLayout implements com.qudaozhang.white.interfaces.OnScrollChangeListener {
	private String TAG = getClass().getName();
	private float xCurr, yCurr, xLast, yLast, offset;

	// 滚动监听
	private com.qudaozhang.white.interfaces.OnScrollChangeListener onScrollChangeListenerl;
	...
	public void setOnScrollChangeListenerl(com.qudaozhang.white.interfaces.OnScrollChangeListener onScrollChangeListenerl) {
