...
public class RegisterActivity extends BaseActivity {
	...
	@Click
	public void ysTv(){
		com.qudaozhang.white.mode.activity.WebViewActivity_.intent(this).local(true).title("隐私保护协议").url("yingsitiaokuan.html").start();

	}
	
	@Click
	public void xieyi1Tv(){
		com.qudaozhang.white.mode.activity.WebViewActivity_.intent(this).local(true).title("注册与服务协议").url("registerXieyi.html").start();
