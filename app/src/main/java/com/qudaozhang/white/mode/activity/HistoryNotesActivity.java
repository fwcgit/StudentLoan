...
import com.qudaozhang.white.mode.adapter.HistoryNotesAdapter;
...
import com.qudaozhang.white.net.data.BorrowArrayResponse;
		...
		listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
			...
			public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
				...
				if(borrow.jieKuanZhuangTai == 2){
					com.qudaozhang.white.mode.activity.HuiGouActivity_.intent(HistoryNotesActivity.this).
