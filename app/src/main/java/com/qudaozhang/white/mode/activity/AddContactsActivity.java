...
import com.qudaozhang.white.net.data.Contact;
import com.qudaozhang.white.net.data.EmergencyContactInfo;
import com.qudaozhang.white.net.data.EmergencyInfo;
