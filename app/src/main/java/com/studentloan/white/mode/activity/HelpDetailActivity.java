...
public class HelpDetailActivity extends BaseActivity {
	...
	"6什么是手机卡运营商服务密码？","7.忘记运营商服务密码怎么办？",
	"8.手机运营商认证失败的原因有哪些？","9. 申请借款的年龄范围？"};
	private String[][] renzhen = new String[][]{
			{"答：用户注册急借白卡后.需要完成信息认证才可申请借款."},
			...
			{"答：急借白卡只提供满18周岁到36周岁的借款"}};

	private String[] jiekuanTitle = new String[]{"1.如何使用急借白卡借款？","2.借款期限是多少？",
	...
	private String[][]feiyong = new String[][]{
			{"答：用户在急借白卡借款.平台收取一定的服务费用.服务费用会在借款成功后收取.和每天0.05%利息.利息将在还款时收取"},
