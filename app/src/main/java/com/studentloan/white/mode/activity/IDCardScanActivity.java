...
import com.studentloan.white.utils.id.utils.DialogUtil;
import com.studentloan.white.utils.id.utils.ICamera;
import com.studentloan.white.utils.id.utils.RotaterUtil;
import com.studentloan.white.utils.id.utils.Util;
import com.studentloan.white.utils.id.view.IDCardIndicator;
import com.studentloan.white.utils.id.view.IDCardNewIndicator;
    ...
    private class DecodeThread extends Thread {
        ...
        private void handleSuccess(IDCardQualityResult result) {
            ...
            if (result.attr.side == IDCardAttr.IDCardSide.IDCARD_SIDE_FRONT) {
                intent.putExtra("portraitImg", Util.bmp2byteArr(result.croppedImageOfIDCard()));
            }
