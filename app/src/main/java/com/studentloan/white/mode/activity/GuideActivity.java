...
public class GuideActivity extends BaseActivity {
	...
	int[] imgsId = new int[]{R.drawable.guid_1,R.drawable.guid_2,R.drawable.guid_3};
	...
	public void startBtn(){
		Intent intent = new Intent(this, com.studentloan.white.mode.activity.LoginActivity_.class);
