...
public class MoreFragment extends BaseFramgent {
	...
	public void aboutInfoLayout(){
		//关于我们
		com.studentloan.white.mode.activity.AboutActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_NEW_TASK).start();
	}
	
	@Click
	public void newHardGuidLayout(){
		com.studentloan.white.mode.activity.GuideActivity_.intent(this).ishowBtn(false).start();
	}
	
	@Click
	public void helpLayout(){
//		//帮助
		com.studentloan.white.mode.activity.HelpActivity_.intent(this).start();
