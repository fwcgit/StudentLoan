...
public class TouchDelView extends LinearLayout {
	...
	public void setSlideViewRight(View slideViewRight,boolean isAdd) {
		this.slideViewRight = slideViewRight;
		measureView(slideViewRight);
		
		if(isAdd){
			LayoutParams footParams=new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
