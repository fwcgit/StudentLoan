...
import com.qudaozhang.white.mode.view.OnDelListener;
import com.qudaozhang.white.mode.view.PullUpView;
import com.qudaozhang.white.mode.view.TouchDelView;
...
public class BoundBankCardActivity extends BaseActivity implements OnRefreshHeadListener{
    ...
    public void rightClick(ImageView rightImg) {
        if(list == null || list.size()+1 < 4){
            com.qudaozhang.white.mode.activity.AddBankCardActivity_.intent(this).
