...
import com.studentloan.white.net.data.HeadImage;
...
import com.studentloan.white.utils.ImageUtils;
...
public class AccountInfoActivity extends BaseActivity {
	...
	public void changePwdLayout(){
		com.studentloan.white.mode.activity.ChangePasswordActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_NEW_TASK).start();
	}
