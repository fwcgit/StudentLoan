 ...
 *
 */
public class PullUpView extends LinearLayout implements com.studentloan.white.interfaces.OnScrollChangeListener {
	private String TAG = getClass().getName();
	private float xCurr, yCurr, xLast, yLast, offset;

	// 滚动监听
	private com.studentloan.white.interfaces.OnScrollChangeListener onScrollChangeListenerl;
	...
	public PullUpView(Context context, AttributeSet attrs) {
		...
		LayoutParams footParams = new LayoutParams(LayoutParams.MATCH_PARENT,
	...
	public void setOnScrollChangeListenerl(com.studentloan.white.interfaces.OnScrollChangeListener onScrollChangeListenerl) {
	...
	public void pullShow() {
		Log.d("fu", "下拉完成----------");
		if (pullStatus.equals(Status.down.toString())) {
			pullDown();
		} else {
			pullUp();
		}
