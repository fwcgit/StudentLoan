...
import com.qudaozhang.white.net.data.Borrow;
import com.qudaozhang.white.net.data.BorrowResponse;
...
@EFragment(R.layout.fragment_huigou_layout)
public class HuiGouFragment extends BaseFramgent {
    ...
    public void alipayTv(){
        ...
        com.qudaozhang.white.mode.activity.AlipayRefundActivity_.intent(this).flags(Intent.FLAG_ACTIVITY_NEW_TASK).start();
    }
    ...
    public void getPdf(String type,String idcard){
        ...
        NoHttpRequest.getInstance().requestPostUrl(getActivity(),formatUrl.hashCode(),params, null,formatUrl,StringResponse.class, new HttpListener<StringResponse>() {
            @Override
        ...
        NoHttpRequest.getInstance().requestGet(getActivity(),formatUrl.hashCode(), formatUrl, GetBankCardResponse.class, new HttpListener<GetBankCardResponse>() {
            ...
            public void onSucceed(int what, Response<GetBankCardResponse> response) {
                ...
                if(response.isSucceed() && response.get() != null){
                    ...
                    DialogUtils.getInstance().selectBankCard(getActivity(), result, new DialogCallback() {
                        @Override
    ...
    private void getXUZHUNumber(final BankCard bankCard){
        ...
        NoHttpRequest.getInstance().requestPost(getActivity(),formatUrl.hashCode(),null, formatUrl, StringResponse.class, new HttpListener<StringResponse>() {
            @Override
            public void onSucceed(int what, Response<StringResponse> response) {
                if(response.isSucceed() && response.get() != null){
    ...
    private void getOrderNumber(final BankCard bankCard){
        ...
        NoHttpRequest.getInstance().requestGet(getActivity(),formatUrl.hashCode(), formatUrl, StringResponse.class, new HttpListener<StringResponse>() {
            @Override
            public void onSucceed(int what, Response<StringResponse> response) {
                if(response.isSucceed() && response.get() != null){
                    if(!TextUtils.isEmpty(response.get().result)){
    ...
    private void pay(BankCard bankCard, String mchntOrdId){
        ...
        String amount = ((int)((br.yingHuanKuanJinE-jl) * 100d)+400)+"";
        ...
        int i = FyPay.pay(getActivity(), bundle, new FyPayCallBack() {
    ...
    private void notifationJiangliE(final int jl){
        ...
        NoHttpRequest.getInstance().requestPut(getActivity(),formatUrl.hashCode(), null,formatUrl,BooleanResponse.class,new HttpListener<BooleanResponse>(){
            @Override
