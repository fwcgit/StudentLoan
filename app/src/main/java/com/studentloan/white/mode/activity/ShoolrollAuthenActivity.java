...
import com.studentloan.white.interfaces.WellCallBack;
import com.studentloan.white.mode.view.DateSelector;
...
public class ShoolrollAuthenActivity extends BaseActivity {
	...
	public void shoolLayout(){
		if(!isChange) return;
		com.studentloan.white.mode.activity.SelectShoolActivity_.intent(this).startForResult(SelectShoolActivity.REQUEST_CODE);
	}
